...
<body>
    ...
    <div class="video-section">
        <div class="video-title">Learn More About Laboratory</div>
        <div class="video-frame">
            <a href="https://laboratory.mx" target="_blank">Visit Laboratory.mx →</a>
            <p style="margin-top: 15px; font-size: 0.9em; color: #666;">Opens in your phone browser</p>
        </div>
    </div>
</body>
</html>
